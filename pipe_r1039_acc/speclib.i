# 1 "/lustre/atlas/scratch/mmin/nti104/nek5_r1039_acc/nek5_r1039_acc/speclib.f"
C=======================================================================
C     
...
C     HGLJ      Compute Gauss-Lobatto Jacobi Lagrangian interpolant (gen
C     
...
C     DGLJGJ    Compute derivative matrix for a staggered mesh (GLJ->GJ)
C     
